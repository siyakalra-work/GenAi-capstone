...
export function StockInPage() {
  ...
  const m = useMutation({
    mutationFn: async () => (await api.post("/inventory/stock-in", { product_id: productId, quantity, notes: notes || null })).data,
  ...
  return (
    <div className="space-y-4">
      <div className="text-xl font-semibold">Stock In</div>
      <Card>
        <form
          className="space-y-3"
          onSubmit={(e) => {
