...
export function StockOutPage() {
  ...
  const m = useMutation({
    mutationFn: async () => (await api.post("/inventory/stock-out", { product_id: productId, quantity, notes: notes || null })).data,
  ...
  return (
    <div className="space-y-4">
      <div className="text-xl font-semibold">Stock Out</div>
      <Card>
        <form
          className="space-y-3"
          onSubmit={(e) => {
